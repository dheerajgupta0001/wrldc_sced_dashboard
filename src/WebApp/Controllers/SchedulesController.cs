...
namespace WebApp.Controllers
{
    ...
    public class SchedulesController : ControllerBase
    {
        ...
        [HttpGet("get")]
        public async Task<List<SchResponse>> GetAsync([FromQuery] string schType = "onbar", [FromQuery] int rev = 0, [FromQuery] int genId = 2, [FromQuery] string starttime = "2021_09_01_00_00_00", [FromQuery] string endtime = "2021_09_01_23_59_59")
        {
            ...
            List<SchResponse> res = await _mediator.Send(new GetSchedulesQuery() { StartTime = startDate, EndTime = endDate, SchType = schType, GenId = genId, RevNo = rev });
            return res;
        }
    }
}
